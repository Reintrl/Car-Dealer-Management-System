...
🟢 **Итого:**  
Этот документ описывает основные сценарии взаимодействия пользователей с системой **Car Dealer**, включая работу с автомобилями, дилерами, заказами и избранным.  
Все варианты использования связаны с диаграммой `use_cases.png`, расположенной в каталоге `/docs/diagrams/images/`.
